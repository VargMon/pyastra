...
# $Id$
#
# Description: PIC 16F59 definition. Pyastra project.
...
"""
Pic 16F59 definition. U{Pyastra project <http://pyastra.sourceforge.net>}.
...
hdikt={'NOT_PD': 0x3, 'DC': 0x1, 'FSR': 0x4,
       ...
       'T0CS': 0x5, 'PORTA': 0x5, 'Z': 0x2,
       'PA0': 0x5, 'PA1': 0x6, 'PA2': 0x7,
       'PSA': 0x3, 'INDF': 0x0, 'TMR0': 0x1,
       }

pages=((0x0, 0x1FF), (0x200, 0x3FF), (0x400, 0x5FF), (0x600, 0x7FF), )

banks=((0xA, 0xF), (0x10, 0x1F), (0x30, 0x3F), (0x50, 0x5F), (0x70, 0x7F), (0x90, 0x9F), (0xB0, 0xBF), (0xD0, 0xDF), (0xF0, 0xFF), )

shareb=(
        ((0xA, 0xF), (0x2A, 0x2F), (0x4A, 0x4F), (0x6A, 0x6F), (0x8A, 0x8F), (0xAA, 0xAF), (0xCA, 0xCF), (0xEA, 0xEF), ),
)

...
class Convertor:
    ...
    @cvar stack: Latest temporary variable number.
    @cvar dikt: User defined variables dictioinary.
    ...
    @cvar asm: True if the source code includes verbatim assembler lines.
    ...
    @todo: Refactor some of the variables ond objects (stack, dikt, label, asm,
      ram_usage, cvar, Memory map, etc).
    @todo: Turn some tuples into objects (funcs, etc).
    """
    ext='asm'
    meta={}

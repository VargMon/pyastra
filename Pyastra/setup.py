...
setup(name='Pyastra',
      ...
      packages=['pyastra', 'pyastra.ports', 'pyastra.ports.pic14', 'pyastra.ports.pic14.modules', 'pyastra.ports.pic14.procs', 'pyastra.ports.pic16', 'pyastra.ports.pic16.modules', 'pyastra.ports.pic16.procs', 'pyastra.convertors', 'pyastra.modules'],
      scripts=['pyastra'],

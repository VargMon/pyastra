...
hdikt={'RCIF': 0x5, 'NOT_T1SYNC': 0x2, 'BF': 0x0,
       ...
       'CCP3Y': 0x4, 'Z': 0x2, 'C2OUT': 0x7,
       'NOT_WRITE': 0x2, 'CIS': 0x3, 'PCFG0': 0x0,
       'CCP3M0': 0x0, 'CCP3M1': 0x1, 'CCP3M2': 0x2,
       'CCP3M3': 0x3, 'SSPADD': 0x93, 'T1CKPS0': 0x4,
       'TXEN': 0x5, 'NOT_TO': 0x4, 'SSPCON': 0x14,
       'TMR2': 0x11, 'TMR0': 0x1, 'IOFS': 0x2,
       'WDTPS2': 0x3, 'BRGH': 0x2, 'VCFG0': 0x4,
       'CCP2IE': 0x0, 'CCPR1L': 0x15, 'READ_WRITE': 0x2,
       'CCP2IF': 0x0, 'ADCS2': 0x6, 'CCPR1H': 0x16,
       'T0IE': 0x5, 'ADCS1': 0x7, 'PEN': 0x2,
       'NOT_PD': 0x3, 'DC': 0x1, 'IBF': 0x7,
       'NOT_BOR': 0x0, 'LVDEN': 0x4, 'TMR1ON': 0x0,
       'RCSTA': 0x18, 'LVDL3': 0x3, 'LVDL2': 0x2,
       'LVDL1': 0x1, 'R_W': 0x2, 'TRMT': 0x1,
       'IRCF1': 0x5, 'PS1': 0x1, 'SSPEN': 0x5,
       'ACKEN': 0x4, 'TUN3': 0x3, 'TUN2': 0x2,
       'GO_DONE': 0x2, 'TUN0': 0x0, 'LVDL0': 0x0,
       'CMCON': 0x9c, 'TUN5': 0x5, 'TUN4': 0x4,
       'TMR0IF': 0x2, 'TMR0IE': 0x5, 'SWDTEN': 0x0,
       'OSFIF': 0x7, 'WCOL': 0x7, 'NOT_POR': 0x1,
       'RP1': 0x6, 'RP0': 0x5, 'T1CKPS1': 0x5,
       'INTF': 0x1, 'IRP': 0x7, 'CCP1IE': 0x2,
       'CCP1X': 0x5, 'CCP1Y': 0x4, 'CMIE': 0x6,
       'CSRC': 0x7, 'TX9': 0x6, 'TMR2ON': 0x2,
       'TMR1IF': 0x0, 'IBOV': 0x5, 'WDTCON': 0x105,
       'SSPM0': 0x0, 'SSPM1': 0x1, 'SSPM2': 0x2,
       'SSPM3': 0x3, 'PMADR': 0x10d, 'I2C_START': 0x3,
       'NOT_ADDRESS': 0x5, 'PMADRH': 0x10f, 'CM2': 0x2,
       'INDF': 0x0, 'CCP3CON': 0x97, 'CM1': 0x1,

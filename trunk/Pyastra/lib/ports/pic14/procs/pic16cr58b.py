...
# $Id$
#
# Description: PIC 16CR58B definition. Pyastra project.
...
"""
Pic 16CR58B definition. U{Pyastra project <http://pyastra.sourceforge.net>}.
...
banks=((0x7, 0xF), (0x10, 0x1F), (0x30, 0x3F), (0x50, 0x5F), (0x70, 0x7F), )

shareb=(
        ((0x7, 0xF), (0x27, 0x2F), (0x47, 0x4F), (0x67, 0x6F), ),
)
